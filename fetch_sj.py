...
def process_vacancy_statistics_sj(app_id, programm_languages):
    ...
    for programm_language_vacancies, all_vacancies_program_language in sj_vacancies.items():
        vacancies_found = len(all_vacancies_program_language)
        vacancies_processed, average_salary = calculate_average_salary_sj(all_vacancies_program_language)
...
def main():
    ...
    if app_id is None:
        ...
        return
    programming_language_statistics = process_vacancy_statistics_sj(app_id, programming_languages)
